aoc_input = """gea agfcbe egcbfd aecb cegbf cafgde fgeba ea gabdf begfdca | bcfeg ea fbdga fbgcdae
...
efgda dgeabf decbag sacefgd edbfa baecgdf ba adb gfab dcfeb | agbf abd gdabfe ab
...
tst_input = """acedgfb cdfbe gcdfa fbcad dab cefabd cdfgeb eafb cagedb ab | cdfeb fcadb cdfeb cdbaf"""
larger_tst_input = """be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb | fdgacbe cefdb cefbgd gcbe
...
tst_single = """be cfbegad cbdgef fgaecd cgeb fdcge agebfd fecdb fabcd edb | fdgacbe cefdb cefbgd gcbe"""
ref_set = """abcefg cf acdeg acdfg bcdf abdfg abdefg acf abcdefg abcdfg | cdfga acf abdfg cf"""
